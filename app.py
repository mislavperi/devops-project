...
app.config['SECRET_KEY'] = 'ftHoa41S988uEEyD7SJpw4xr9eftmUBDUKJjl9u1pkCvUADONcdbEsUSXKh0TTn2'

# Configure database details, these need to be changed depending on how you configured mysql container
db_user = environ.get('DB_USER', 'mislav')
db_pass = environ.get('DB_PASS', 'hiddengems')
db_host = environ.get('DB_HOST', 'database')
db_name = environ.get('DB_NAME', 'devopsproject')
